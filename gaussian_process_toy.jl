...
# ╔═╡ bdd1d520-44dd-11ed-1cb3-b5e971499a5f
using GaussianProcesses, CairoMakie

# ╔═╡ 151b29f4-a498-4d63-ade0-f46b8491cba6
begin
xs = [0.0, 1.0, 3.0, 5.0]
...
# ╔═╡ 31c5e0d7-b7c0-44d6-bf32-30eac31280e3
gp = GP(xs, ys, MeanZero(), SE(1.0, 4.0))

# ╔═╡ c817dccd-8546-4f6c-9ecc-c399e599a26f
x = range(0.0, maximum(xs), length=100)

# ╔═╡ 135edbc7-bade-4c61-862e-75db766bc16a
μ, σ² = predict_y(gp, x)

# ╔═╡ 51ff7ac1-7fca-4ed1-aa83-c623404deeca
begin
fig = Figure()
	ax = Axis(fig[1,1])
	lines!(x, μ)
